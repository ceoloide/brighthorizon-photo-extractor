...
with sync_playwright() as p:
    ...
    context = p.chromium.launch_persistent_context(
        "/tmp/real_chrome_dir",
        executable_path="/usr/bin/chromium", # Real system Chromium!
        headless=False,
        args=args,
    ...
    print("1. Navigating to /okta/login with system Chromium...")
    ...
    if pwd_inp.count() > 0 and pwd_inp.first.is_visible():
        print("SUCCESS! System Chromium revealed password input!")
